...
const CounsellorDetails = () => {
  ...
  const handleStartChat = async (counsellorId) => {
    ...
    try {
      ...
      console.log("Chat Created:", realChatId);
            ...
            >
              ...
              <div className="counsellordetails-info">
                ...
                <div className="counsellordetails-extra">
                  ...
                  <span>
                    Specialist : {counsellor.specialist}
                  </span>
                ...
                <button
                  ...
                  onClick={() =>
                    handleStartChat(counsellor._id)
                  }
                >
                  Start Chat
                </button>
